...
namespace Pandora.NetStandard.Data.Dals
{
    ...
    /// </remarks>
    public class RepositoryProvider<TContext> : IRepositoryProvider<TContext> where TContext : ApplicationDbContext
    {
        /// <summary>
        ...
        /// </param>
        /// <returns></returns>
        protected virtual T MakeRepository<T>(Func<TContext, object> factory, TContext dbContext)
        {
